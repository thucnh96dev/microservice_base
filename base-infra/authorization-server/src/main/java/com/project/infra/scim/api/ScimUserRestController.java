package com.project.infra.scim.api;

import com.project.infra.scim.api.resource.CreateScimUserResource;
import com.project.infra.scim.api.resource.ScimUserListResource;
import com.project.infra.scim.api.resource.ScimUserResource;
import com.project.infra.scim.api.resource.mapper.CreateScimUserResourceMapper;
import com.project.infra.scim.api.resource.mapper.ScimUserListResourceMapper;
import com.project.infra.scim.api.resource.mapper.ScimUserResourceMapper;
        ...
        return scimService.findAllUsers().stream().map(ue -> {
            URI location =
                    ServletUriComponentsBuilder.fromCurrentContextPath()
                            ...
                            .toUri();
            return scimUserListResourceMapper.mapEntityToResource(ue, location.toASCIIString());
