...
import com.project.infra.oauth.client.dao.RegisteredClientRepository;
...
import com.project.infra.scim.dao.ScimGroupEntityRepository;
import com.project.infra.scim.dao.ScimUserEntityRepository;
import com.project.infra.scim.dao.ScimUserGroupEntityRepository;
import com.project.infra.scim.model.ScimEmailEntity;
        ...
        Set<RegisteredClient> registeredClients =
                Stream.of(
                                ...
                                new RegisteredClient(
                                        ...
                                        Set.of(GrantType.AUTHORIZATION_CODE, GrantType.CLIENT_CREDENTIALS, GrantType.PASSWORD, GrantType.REFRESH_TOKEN),
                                        Collections.singleton(
                                                "http://localhost:7419/login/oauth2/code/oidc"),
                                        Collections.singleton("*")),
                                new RegisteredClient(
                                        UUID.randomUUID(),
                                        "public-jwt-angular",
                                        ...
                                        Collections.singleton("http://localhost:8080")),
                                new RegisteredClient(
                                        UUID.randomUUID(),
                                        "confidential-opaque",
                                        passwordEncoder.encode("demo"),
