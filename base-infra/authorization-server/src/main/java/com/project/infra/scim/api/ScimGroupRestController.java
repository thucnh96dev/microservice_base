...
import com.project.infra.scim.api.resource.mapper.ScimGroupListResourceMapper;
import com.project.infra.scim.api.resource.mapper.ScimGroupResourceMapper;
        ...
        return scimService.findAllGroups().stream().map(ue -> {
            URI location =
                    ServletUriComponentsBuilder.fromCurrentContextPath()
                            ...
                            .toUri();
            return scimGroupListResourceMapper.mapEntityToResource(ue, location.toASCIIString());
