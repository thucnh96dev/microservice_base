...
import com.project.infra.security.client.RegisteredClientDetailsService;
import com.project.infra.security.user.EndUserDetailsService;
...
public class WebSecurityConfiguration {
    ...
    public static class ApiEndpoints extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
                    .and().requestMatchers(r -> r.mvcMatchers("/api/**"))
                    .authorizeRequests(
                            a -> {
