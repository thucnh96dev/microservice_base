...
public class GatewayConfiguration {
    ...
    ReactiveHealthContributor coreServices() {
        ...
        Map<String, ReactiveHealthContributor> healthIndicators = new HashMap<>();

        healthIndicators.put("Product Service", productHealthIndicator);
        healthIndicators.put("Recommendation Service", recommendationHealthIndicator);
        healthIndicators.put("Review Service", reviewHealthIndicator);
        healthIndicators.put("Store Service", storeHealthIndicator);
        healthIndicators.put("Authorization Server", authHealthIndicator);
