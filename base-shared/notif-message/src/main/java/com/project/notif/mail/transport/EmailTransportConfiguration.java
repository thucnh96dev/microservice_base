...
public class EmailTransportConfiguration {
     ...
     *
     * @param smtpServer The SMTP server to use for mail transport. To use a specific
     ...
     * @param smtpServer             The SMTP server to use for mail transport. To use a specific
     *                               port, user the syntax server:port.
     * @param authenticationRequired Informs if mail transport needs to authenticate to send mail
     *                               or not.
